<template lang="html">
  <div :val="value_" class="second-and-minute">
    ...
    <div class="row">
      ...
      <base-input-number v-model="cycle.start" :min="2000" size="mini" style="width: 100px" @change="type = '2'"></base-input-number>
      <span style="margin-right: 5px; margin-left: 5px">至</span>
      <base-input-number v-model="cycle.end" :min="2000" size="mini" style="width: 100px" @change="type = '2'"></base-input-number>
      年
    </div>
  </div>
</template>
