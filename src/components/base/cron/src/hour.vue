<template lang="html">
  <div :val="value_" class="second-and-minute">
    ...
    <div class="row">
      ...
      <base-input-number v-model="cycle.start" :min="0" :max="23" size="mini" style="width: 100px" @change="type = '2'"></base-input-number>
      <span style="margin-right: 5px; margin-left: 5px">至</span>
      <base-input-number v-model="cycle.end" :min="2" :max="23" size="mini" style="width: 100px" @change="type = '2'"></base-input-number>
      时
    </div>
    <div class="row">
      <el-radio v-model="type" label="3" size="mini" border>循环</el-radio>
      <span style="margin-right: 5px; margin-left: 10px">从</span>
      <base-input-number v-model="loop.start" :min="0" :max="23" size="mini" style="width: 100px" @change="type = '3'"></base-input-number>
      <span style="margin-right: 5px; margin-left: 5px">时开始，每</span>
      <base-input-number v-model="loop.end" :min="1" :max="23" size="mini" style="width: 100px" @change="type = '3'"></base-input-number>
      时执行一次
    </div>
    <div class="row">
      <el-radio v-model="type" label="4" size="mini" border>指定</el-radio>
      <el-checkbox-group v-model="appoint">
        <div v-for="i in 3" :key="i" style="line-height: 18px">
