<template lang="html">
  <div :val="value_" class="second-and-minute">
    ...
    <div class="row">
      ...
      <base-input-number v-model="cycle.start" :min="1" :max="12" size="mini" style="width: 100px" @change="type = '2'"></base-input-number>
      <span style="margin-right: 5px; margin-left: 5px">至</span>
      <base-input-number v-model="cycle.end" :min="2" :max="12" size="mini" style="width: 100px" @change="type = '2'"></base-input-number>
      月
    </div>
    <div class="row">
      <el-radio v-model="type" label="3" size="mini" border>循环</el-radio>
      <span style="margin-right: 5px; margin-left: 10px">从</span>
      <base-input-number v-model="loop.start" :min="1" :max="12" size="mini" style="width: 100px" @change="type = '3'"></base-input-number>
      <span style="margin-right: 5px; margin-left: 5px">月开始，每</span>
      <base-input-number v-model="loop.end" :min="1" :max="12" size="mini" style="width: 100px" @change="type = '3'"></base-input-number>
      月执行一次
    </div>
    <div class="row">
      <el-radio v-model="type" label="4" size="mini" border>指定</el-radio>
      <el-checkbox-group v-model="appoint" style="line-height: 18px">
        <el-checkbox v-for="i in 12" :key="i" :label="i + ''" @change="type = '4'"></el-checkbox>
      </el-checkbox-group>
    </div>
  </div>
</template>
