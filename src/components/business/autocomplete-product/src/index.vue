...
export default {
  name: 'BusinessAutocompleteProduct',
  components: { Grid },
  inject: {
    elForm: {
      default: ''
...
<template>
  <div class="business-autocomplete-product">
    <base-autocomplete
    ...
    <base-dialog class="business-autocomplete-product-dialog" width="1100px" :title="label" :visible.sync="visible" :show-footer="false">
