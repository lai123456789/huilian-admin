...
export default {
  name: 'BusinessAutocompleteWarehouse',
  components: { Grid },
  inject: {
    elForm: {
      default: ''
...
<template>
  <div class="business-autocomplete-warehouse">
    <base-autocomplete
    ...
    <base-dialog class="business-autocomplete-warehouse-dialog" width="1100px" :title="label" :visible.sync="visible" :show-footer="false">
