<script>
import { getCompanyPrincipalById } from '@/api/company/company-principal'
  ...
  methods: {
    ...
    async getDetailsData(cb) {
      ...
      const [dicts, info] = await Promise.all([
        ...
        getCompanyPrincipalById(this.tableRow.id)
      ])
...
<template>
  <div
    v-loading="loading"
    class="common-operate sub-company-details"
            ...
            <base-row :gutter="10">
              ...
              <base-col :span="6">
                <base-form-item label="企业简称" prop="companyShortName">
                  <base-input v-model="form.companyShortName" />
                </base-form-item>
              </base-col>
