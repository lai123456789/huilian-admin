  ...
  created() {
    if (this.orderType === enums.ORDER_TYPE.getFieldByKey('IMPORT')) {
      this.annexConfig = {
        ...
        permissionsAnnex: {
          add: constant.PERMISSION_PRICE_REVIEW_IMPORT_ANNEX_UPLOAD,
          del: constant.PERMISSION_PRICE_REVIEW_IMPORT_ANNEX_DEL
        },
        fileModule: constant.FILE_MODULE_PRICE_REVIEW_IMPORT
      }
    } else {
      this.annexConfig = {
        fileTypeName: constant.DICTS_FILE_MODULE,
        permissionsAnnex: {
          add: constant.PERMISSION_PRICE_REVIEW_EXPORT_ANNEX_UPLOAD,
          del: constant.PERMISSION_PRICE_REVIEW_EXPORT_ANNEX_DEL
        },
        fileModule: constant.FILE_MODULE_PRICE_REVIEW_EXPORT
      }
    }
  },
  methods: {
