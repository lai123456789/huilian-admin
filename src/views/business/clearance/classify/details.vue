<script>
import { getCustomsDeclarById } from '@/api/customs/customs-declar'
    ...
    async getDetailsData(cb) {
      ...
      Promise.all([
        ...
        this.generateClassifyElements(clone(this.form.classifyElements, true) || []).then(classifyElements => {
          ...
          this.showBtns = {
            edit: this.permissions[constant.PERMISSION_CLASSIFY_EDIT],
            del: this.permissions[constant.PERMISSION_CLASSIFY_DEL]
          }
