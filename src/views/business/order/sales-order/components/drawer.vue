...
import { getOrderSaleOperRecord } from '@/api/order/order-sale-oper-record'
...
export default {
  ...
  created() {
    this.permissionsCostInvoice = {
      add: constant.PERMISSION_BUS_SALES_ACCT_COST_INVO_ADD,
      del: constant.PERMISSION_BUS_SALES_ACCT_COST_INVO_DEL
    }
    this.permissionsCostPay = {
      add: constant.PERMISSION_BUS_SALES_ACCT_COST_PAY_ADD,
      edit: constant.PERMISSION_BUS_SALES_ACCT_COST_PAY_EDIT,
      del: constant.PERMISSION_BUS_SALES_ACCT_COST_PAY_DEL,
      pay: constant.PERMISSION_BUS_SALES_ACCT_COST_PAY_JUMP
    }
    this.permissionsShipping = {
      add: constant.PERMISSION_BUS_SALES_WR_SHIPPING_ADD
    }
    this.annexConfig = {
      fileTypeName: constant.DICTS_FILE_MODULE,
      permissionsAnnex: {
        add: constant.PERMISSION_BUS_SALES_ANNEX_UPLOAD,
        del: constant.PERMISSION_BUS_SALES_ANNEX_DEL
      },
      fileModule: constant.FILE_MODULE_SALE_ORDER
    }
    this.operRecordConfig = {
      pagePort: getOrderSaleOperRecord
    }
  },
  methods: {
    createPage() {
