...
import { getCustomsTransportOperRecord } from '@/api/customs/customs-transport-oper-record'
...
export default {
  ...
  created() {
    this.annexConfig = {
      ...
      permissionsAnnex: {
        add: constant.PERMISSION_HG_TRUCK_ANNEX_UPLOAD,
        del: constant.PERMISSION_HG_TRUCK_ANNEX_DEL
      },
      fileModule: constant.FILE_MODULE_HG_TRUCK
    }
    this.operRecordConfig = {
      pagePort: getCustomsTransportOperRecord
    }
  },
  methods: {
    createPage() {
