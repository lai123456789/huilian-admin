...
import { getWareDeliveryExpressOperRecord } from '@/api/warehouse/ware-delivery-express-oper-record'
...
export default {
  ...
  created() {
    this.annexConfig = {
      ...
      permissionsAnnex: {
        add: constant.PERMISSION_EXPRESS_NO_ANNEX_UPLOAD,
        del: constant.PERMISSION_EXPRESS_NO_ANNEX_DEL
      },
      fileModule: constant.FILE_MODULE_EXPRESS_NO
    }
    this.operRecordConfig = {
      pagePort: getWareDeliveryExpressOperRecord
    }
  },
  methods: {
    createPage() {
