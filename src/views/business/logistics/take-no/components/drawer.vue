...
import { getWareDeliveryTakeOperRecord } from '@/api/warehouse/ware-delivery-take-oper-record'
...
export default {
  ...
  created() {
    this.annexConfig = {
      ...
      permissionsAnnex: {
        add: constant.PERMISSION_TAKE_NO_ANNEX_UPLOAD,
        del: constant.PERMISSION_TAKE_NO_ANNEX_DEL
      },
      fileModule: constant.FILE_MODULE_TAKE_NO
    }
    this.operRecordConfig = {
      pagePort: getWareDeliveryTakeOperRecord
    }
  },
  methods: {
    createPage() {
