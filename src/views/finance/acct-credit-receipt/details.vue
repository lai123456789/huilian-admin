<script>
import { getAcctLetterOfCreditReceiptById } from '@/api/finance/acct-letter-of-credit-receipt'
    ...
    async getDetailsData(cb) {
      this.$nextTick(() => {
        ...
        Promise.all([
          ...
          getAcctLetterOfCreditReceiptById(this.tableRow.id)
        ]).then(([dicts, info]) => {
          ...
          this.showBtns = {
            edit: this.permissions[constant.PERMISSION_ACCT_CREDIT_RECEIPT_EDIT],
            del: this.permissions[constant.PERMISSION_ACCT_CREDIT_RECEIPT_DEL]
          }
...
<template>
  <div
    v-loading="loading"
    class="common-operate acct-credit-receipt is-details-adaptive"
    ...
    <div class="common-operate-t">
      <div class="common-operate-l">
        <div class="common-operate-l-main">
          <base-form ref="formRef" :model="form" label-width="115px" size="mini">
            <!-- 基本信息 -->
              ...
              <base-row>
                ...
                <base-col :span="6">
                  <base-form-item label="收证日期" prop="receiptDate">
                    <base-date-picker v-model="form.receiptDate" disabled type="date" placeholder="选择收证日期" />
                  </base-form-item>
                </base-col>
              ...
              <base-row>
                <base-col :span="6">
                  <base-form-item label="申请人类型" prop="applicantCompanyType">
                    <base-select
                      v-model="form.applicantCompanyType"
                      disabled
                      placeholder="请选择申请人类型"
                      :options="applicantCompanyTypes"
                    />
                  </base-form-item>
                </base-col>
              ...
              <base-row>
                ...
                <base-col :span="6">
                  <base-form-item label="交单期限" prop="deliveryDate">
                    <base-date-picker v-model="form.deliveryDate" disabled type="daterange" placeholder="选择交单期限" />
                  </base-form-item>
                </base-col>
